...
Right now Pico Transit knows its way around **MBTA**, **RIPTA**, **RTD Denver**, **LTC Ontario**, and **STM Montréal**, with more agencies hopefully hopping aboard down the road. It's built on the [Light SDK](../) for the Light Phone III, so it stays just as calm and un-distracting as the rest of your Light experience.
...
- 📍 **Explore/Leave now** — type where you are (or let Pico Transit take a quick IP-based guess 🛰️) and get the closest stops, nearest first — it remembers your last search, so ducking into a stop's arrivals and back doesn't make you search all over again.
